...
#MNAR I
BMY_I <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMY_I.xlsx', 1)
BMCY_I <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMCY_I.xlsx', 1)
CMY_I <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMY_I.xlsx', 1)
CMBY_I <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMBY_I.xlsx', 1)
...
BMY_I_NIE_MLE<-cbind(BMY_I[c(17),4,],'NIE','MLE','A.I')
...
BMY_I_NDE_MLE<-cbind(BMY_I[c(18),4,],'NDE','MLE','A.I')
...
BMCY_I_NIE_MLE<-cbind(BMCY_I[c(18),4,],'NIE','MLE','B.I')
...
BMCY_I_NDE_MLE<-cbind(BMCY_I[c(19),4,],'NDE','MLE','B.I')
...
CMY_I_NIE_MLE<-cbind(CMY_I[c(19),4,],'NIE','MLE','C.I')
...
CMY_I_NDE_MLE<-cbind(CMY_I[c(20),4,],'NDE','MLE','C.I')
...
CMBY_I_NIE_MLE<-cbind(CMBY_I[c(18),4,],'NIE','MLE','D.I')
...
CMBY_I_NDE_MLE<-cbind(CMBY_I[c(19),4,],'NDE','MLE','D.I')

MNAR_I<-as.data.frame(rbind(BMY_I_NIE_OR,BMY_I_NIE_CC,BMY_I_NIE_MI,BMY_I_NIE_MLE,
                            BMY_I_NDE_OR,BMY_I_NDE_CC,BMY_I_NDE_MI,BMY_I_NDE_MLE,
                            BMCY_I_NIE_OR,BMCY_I_NIE_CC,BMCY_I_NIE_MI,BMCY_I_NIE_MLE,
                            BMCY_I_NDE_OR,BMCY_I_NDE_CC,BMCY_I_NDE_MI,BMCY_I_NDE_MLE,
                            CMY_I_NIE_OR,CMY_I_NIE_CC,CMY_I_NIE_MI,CMY_I_NIE_MLE,
                            CMY_I_NDE_OR,CMY_I_NDE_CC,CMY_I_NDE_MI,CMY_I_NDE_MLE,
                            CMBY_I_NIE_OR,CMBY_I_NIE_CC,CMBY_I_NIE_MI,CMBY_I_NIE_MLE,
                            CMBY_I_NDE_OR,CMBY_I_NDE_CC,CMBY_I_NDE_MI,CMBY_I_NDE_MLE))
...
MNAR_I$method <- factor(MNAR_I$method, levels=c("CC","MI","MLE","OR"))

#MNAR II
BMY_II <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMY_II.xlsx', 1)
BMCY_II <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMCY_II.xlsx', 1)
CMY_II <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMY_II.xlsx', 1)
CMBY_II <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMBY_II.xlsx', 1)
...
BMY_II_NIE_MLE<-cbind(BMY_II[c(21),4,],'NIE','MLE','A.II')
...
BMY_II_NDE_MLE<-cbind(BMY_II[c(22),4,],'NDE','MLE','A.II')
...
BMCY_II_NIE_MLE<-cbind(BMCY_II[c(22),4,],'NIE','MLE','B.II')
...
BMCY_II_NDE_MLE<-cbind(BMCY_II[c(23),4,],'NDE','MLE','B.II')
...
CMY_II_NIE_MLE<-cbind(CMY_II[c(23),4,],'NIE','MLE','C.II')
...
CMY_II_NDE_MLE<-cbind(CMY_II[c(24),4,],'NDE','MLE','C.II')
...
CMBY_II_NIE_MLE<-cbind(CMBY_II[c(22),4,],'NIE','MLE','D.II')
...
CMBY_II_NDE_MLE<-cbind(CMBY_II[c(23),4,],'NDE','MLE','D.II')

MNAR_II<-as.data.frame(rbind(BMY_II_NIE_OR,BMY_II_NIE_CC,BMY_II_NIE_MI,BMY_II_NIE_MLE,
                             BMY_II_NDE_OR,BMY_II_NDE_CC,BMY_II_NDE_MI,BMY_II_NDE_MLE,
                             BMCY_II_NIE_OR,BMCY_II_NIE_CC,BMCY_II_NIE_MI,BMCY_II_NIE_MLE,
                             BMCY_II_NDE_OR,BMCY_II_NDE_CC,BMCY_II_NDE_MI,BMCY_II_NDE_MLE,
                             CMY_II_NIE_OR,CMY_II_NIE_CC,CMY_II_NIE_MI,CMY_II_NIE_MLE,
                             CMY_II_NDE_OR,CMY_II_NDE_CC,CMY_II_NDE_MI,CMY_II_NDE_MLE,
                             CMBY_II_NIE_OR,CMBY_II_NIE_CC,CMBY_II_NIE_MI,CMBY_II_NIE_MLE,
                             CMBY_II_NDE_OR,CMBY_II_NDE_CC,CMBY_II_NDE_MI,CMBY_II_NDE_MLE))
...
MNAR_II$method <- factor(MNAR_II$method, levels=c("CC","MI","MLE","OR"))

#MNAR III
BMY_III <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMY_III.xlsx', 1)
BMCY_III <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMCY_III.xlsx', 1)
CMY_III <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMY_III.xlsx', 1)
CMBY_III <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMBY_III.xlsx', 1)
...
BMY_III_NIE_MLE<-cbind(BMY_III[c(21),4,],'NIE','MLE','A.III')
...
BMY_III_NDE_MLE<-cbind(BMY_III[c(22),4,],'NDE','MLE','A.III')
...
BMCY_III_NIE_MLE<-cbind(BMCY_III[c(22),4,],'NIE','MLE','B.III')
...
BMCY_III_NDE_MLE<-cbind(BMCY_III[c(23),4,],'NDE','MLE','B.III')
...
CMY_III_NIE_MLE<-cbind(CMY_III[c(23),4,],'NIE','MLE','C.III')
...
CMY_III_NDE_MLE<-cbind(CMY_III[c(24),4,],'NDE','MLE','C.III')
...
CMBY_III_NIE_MLE<-cbind(CMBY_III[c(22),4,],'NIE','MLE','D.III')
...
CMBY_III_NDE_MLE<-cbind(CMBY_III[c(23),4,],'NDE','MLE','D.III')

MNAR_III<-as.data.frame(rbind(BMY_III_NIE_OR,BMY_III_NIE_CC,BMY_III_NIE_MI,BMY_III_NIE_MLE,
                              BMY_III_NDE_OR,BMY_III_NDE_CC,BMY_III_NDE_MI,BMY_III_NDE_MLE,
                              BMCY_III_NIE_OR,BMCY_III_NIE_CC,BMCY_III_NIE_MI,BMCY_III_NIE_MLE,
                              BMCY_III_NDE_OR,BMCY_III_NDE_CC,BMCY_III_NDE_MI,BMCY_III_NDE_MLE,
                              CMY_III_NIE_OR,CMY_III_NIE_CC,CMY_III_NIE_MI,CMY_III_NIE_MLE,
                              CMY_III_NDE_OR,CMY_III_NDE_CC,CMY_III_NDE_MI,CMY_III_NDE_MLE,
                              CMBY_III_NIE_OR,CMBY_III_NIE_CC,CMBY_III_NIE_MI,CMBY_III_NIE_MLE,
                              CMBY_III_NDE_OR,CMBY_III_NDE_CC,CMBY_III_NDE_MI,CMBY_III_NDE_MLE))
...
MNAR_III$method <- factor(MNAR_III$method, levels=c("CC","MI","MLE","OR"))

#MNAR IV
BMY_IV <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMY_IV.xlsx', 1)
BMCY_IV <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMCY_IV.xlsx', 1)
CMY_IV <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMY_IV.xlsx', 1)
CMBY_IV <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMBY_IV.xlsx', 1)
...
BMY_IV_NIE_MLE<-cbind(BMY_IV[c(21),4,],'NIE','MLE','A.IV')
...
BMY_IV_NDE_MLE<-cbind(BMY_IV[c(22),4,],'NDE','MLE','A.IV')
...
BMCY_IV_NIE_MLE<-cbind(BMCY_IV[c(22),4,],'NIE','MLE','B.IV')
...
BMCY_IV_NDE_MLE<-cbind(BMCY_IV[c(23),4,],'NDE','MLE','B.IV')
...
CMY_IV_NIE_MLE<-cbind(CMY_IV[c(23),4,],'NIE','MLE','C.IV')
...
CMY_IV_NDE_MLE<-cbind(CMY_IV[c(24),4,],'NDE','MLE','C.IV')
...
CMBY_IV_NIE_MLE<-cbind(CMBY_IV[c(22),4,],'NIE','MLE','D.IV')
...
CMBY_IV_NDE_MLE<-cbind(CMBY_IV[c(23),4,],'NDE','MLE','D.IV')

MNAR_IV<-as.data.frame(rbind(BMY_IV_NIE_OR,BMY_IV_NIE_CC,BMY_IV_NIE_MI,BMY_IV_NIE_MLE,
                             BMY_IV_NDE_OR,BMY_IV_NDE_CC,BMY_IV_NDE_MI,BMY_IV_NDE_MLE,
                             BMCY_IV_NIE_OR,BMCY_IV_NIE_CC,BMCY_IV_NIE_MI,BMCY_IV_NIE_MLE,
                             BMCY_IV_NDE_OR,BMCY_IV_NDE_CC,BMCY_IV_NDE_MI,BMCY_IV_NDE_MLE,
                             CMY_IV_NIE_OR,CMY_IV_NIE_CC,CMY_IV_NIE_MI,CMY_IV_NIE_MLE,
                             CMY_IV_NDE_OR,CMY_IV_NDE_CC,CMY_IV_NDE_MI,CMY_IV_NDE_MLE,
                             CMBY_IV_NIE_OR,CMBY_IV_NIE_CC,CMBY_IV_NIE_MI,CMBY_IV_NIE_MLE,
                             CMBY_IV_NDE_OR,CMBY_IV_NDE_CC,CMBY_IV_NDE_MI,CMBY_IV_NDE_MLE))
...
MNAR_IV$method <- factor(MNAR_IV$method, levels=c("CC","MI","MLE","OR"))
...
#MNAR I (NULL)
BMY0_I <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMY_I(0).xlsx', 1)
BMCY0_I <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMCY_I(0).xlsx', 1)
CMY0_I <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMY_I(0).xlsx', 1)
CMBY0_I <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMBY_I(0).xlsx', 1)
...
BMY0_I_NIE_MLE<-cbind(BMY0_I[c(17),4,],'NIE','MLE','A.I (0)')
...
BMY0_I_NDE_MLE<-cbind(BMY0_I[c(18),4,],'NDE','MLE','A.I (0)')
...
BMCY0_I_NIE_MLE<-cbind(BMCY0_I[c(18),4,],'NIE','MLE','B.I (0)')
...
BMCY0_I_NDE_MLE<-cbind(BMCY0_I[c(19),4,],'NDE','MLE','B.I (0)')
...
CMY0_I_NIE_MLE<-cbind(CMY0_I[c(19),4,],'NIE','MLE','C.I (0)')
...
CMY0_I_NDE_MLE<-cbind(CMY0_I[c(20),4,],'NDE','MLE','C.I (0)')
...
CMBY0_I_NIE_MLE<-cbind(CMBY0_I[c(18),4,],'NIE','MLE','D.I (0)')
...
CMBY0_I_NDE_MLE<-cbind(CMBY0_I[c(19),4,],'NDE','MLE','D.I (0)')

MNAR0_I<-as.data.frame(rbind(BMY0_I_NIE_OR,BMY0_I_NIE_CC,BMY0_I_NIE_MI,BMY0_I_NIE_MLE,
                             BMY0_I_NDE_OR,BMY0_I_NDE_CC,BMY0_I_NDE_MI,BMY0_I_NDE_MLE,
                             BMCY0_I_NIE_OR,BMCY0_I_NIE_CC,BMCY0_I_NIE_MI,BMCY0_I_NIE_MLE,
                             BMCY0_I_NDE_OR,BMCY0_I_NDE_CC,BMCY0_I_NDE_MI,BMCY0_I_NDE_MLE,
                             CMY0_I_NIE_OR,CMY0_I_NIE_CC,CMY0_I_NIE_MI,CMY0_I_NIE_MLE,
                             CMY0_I_NDE_OR,CMY0_I_NDE_CC,CMY0_I_NDE_MI,CMY0_I_NDE_MLE,
                             CMBY0_I_NIE_OR,CMBY0_I_NIE_CC,CMBY0_I_NIE_MI,CMBY0_I_NIE_MLE,
                             CMBY0_I_NDE_OR,CMBY0_I_NDE_CC,CMBY0_I_NDE_MI,CMBY0_I_NDE_MLE))
...
MNAR0_I$method <- factor(MNAR0_I$method, levels=c("CC","MI","MLE","OR"))

#MNAR II (NULL)
BMY0_II <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMY_II(0).xlsx', 1)
BMCY0_II <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMCY_II(0).xlsx', 1)
CMY0_II <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMY_II(0).xlsx', 1)
CMBY0_II <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMBY_II(0).xlsx', 1)
...
BMY0_II_NIE_MLE<-cbind(BMY0_II[c(21),4,],'NIE','MLE','A.II (0)')
...
BMY0_II_NDE_MLE<-cbind(BMY0_II[c(22),4,],'NDE','MLE','A.II (0)')
...
BMCY0_II_NIE_MLE<-cbind(BMCY0_II[c(22),4,],'NIE','MLE','B.II (0)')
...
BMCY0_II_NDE_MLE<-cbind(BMCY0_II[c(23),4,],'NDE','MLE','B.II (0)')
...
CMY0_II_NIE_MLE<-cbind(CMY0_II[c(23),4,],'NIE','MLE','C.II (0)')
...
CMY0_II_NDE_MLE<-cbind(CMY0_II[c(24),4,],'NDE','MLE','C.II (0)')
...
CMBY0_II_NIE_MLE<-cbind(CMBY0_II[c(22),4,],'NIE','MLE','D.II (0)')
...
CMBY0_II_NDE_MLE<-cbind(CMBY0_II[c(23),4,],'NDE','MLE','D.II (0)')

MNAR0_II<-as.data.frame(rbind(BMY0_II_NIE_OR,BMY0_II_NIE_CC,BMY0_II_NIE_MI,BMY0_II_NIE_MLE,
                              BMY0_II_NDE_OR,BMY0_II_NDE_CC,BMY0_II_NDE_MI,BMY0_II_NDE_MLE,
                              BMCY0_II_NIE_OR,BMCY0_II_NIE_CC,BMCY0_II_NIE_MI,BMCY0_II_NIE_MLE,
                              BMCY0_II_NDE_OR,BMCY0_II_NDE_CC,BMCY0_II_NDE_MI,BMCY0_II_NDE_MLE,
                              CMY0_II_NIE_OR,CMY0_II_NIE_CC,CMY0_II_NIE_MI,CMY0_II_NIE_MLE,
                              CMY0_II_NDE_OR,CMY0_II_NDE_CC,CMY0_II_NDE_MI,CMY0_II_NDE_MLE,
                              CMBY0_II_NIE_OR,CMBY0_II_NIE_CC,CMBY0_II_NIE_MI,CMBY0_II_NIE_MLE,
                              CMBY0_II_NDE_OR,CMBY0_II_NDE_CC,CMBY0_II_NDE_MI,CMBY0_II_NDE_MLE))
...
MNAR0_II$method <- factor(MNAR0_II$method, levels=c("CC","MI","MLE","OR"))

#MNAR III (NULL)
BMY0_III <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMY_III(0).xlsx', 1)
BMCY0_III <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMCY_III(0).xlsx', 1)
CMY0_III <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMY_III(0).xlsx', 1)
CMBY0_III <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMBY_III(0).xlsx', 1)
...
BMY0_III_NIE_MLE<-cbind(BMY0_III[c(21),4,],'NIE','MLE','A.III (0)')
...
BMY0_III_NDE_MLE<-cbind(BMY0_III[c(22),4,],'NDE','MLE','A.III (0)')
...
BMCY0_III_NIE_MLE<-cbind(BMCY0_III[c(22),4,],'NIE','MLE','B.III (0)')
...
BMCY0_III_NDE_MLE<-cbind(BMCY0_III[c(23),4,],'NDE','MLE','B.III (0)')
...
CMY0_III_NIE_MLE<-cbind(CMY0_III[c(23),4,],'NIE','MLE','C.III (0)')
...
CMY0_III_NDE_MLE<-cbind(CMY0_III[c(24),4,],'NDE','MLE','C.III (0)')
...
CMBY0_III_NIE_MLE<-cbind(CMBY0_III[c(22),4,],'NIE','MLE','D.III (0)')
...
CMBY0_III_NDE_MLE<-cbind(CMBY0_III[c(23),4,],'NDE','MLE','D.III (0)')

MNAR0_III<-as.data.frame(rbind(BMY0_III_NIE_OR,BMY0_III_NIE_CC,BMY0_III_NIE_MI,BMY0_III_NIE_MLE,
                               BMY0_III_NDE_OR,BMY0_III_NDE_CC,BMY0_III_NDE_MI,BMY0_III_NDE_MLE,
                               BMCY0_III_NIE_OR,BMCY0_III_NIE_CC,BMCY0_III_NIE_MI,BMCY0_III_NIE_MLE,
                               BMCY0_III_NDE_OR,BMCY0_III_NDE_CC,BMCY0_III_NDE_MI,BMCY0_III_NDE_MLE,
                               CMY0_III_NIE_OR,CMY0_III_NIE_CC,CMY0_III_NIE_MI,CMY0_III_NIE_MLE,
                               CMY0_III_NDE_OR,CMY0_III_NDE_CC,CMY0_III_NDE_MI,CMY0_III_NDE_MLE,
                               CMBY0_III_NIE_OR,CMBY0_III_NIE_CC,CMBY0_III_NIE_MI,CMBY0_III_NIE_MLE,
                               CMBY0_III_NDE_OR,CMBY0_III_NDE_CC,CMBY0_III_NDE_MI,CMBY0_III_NDE_MLE))
...
MNAR0_III$method <- factor(MNAR0_III$method, levels=c("CC","MI","MLE","OR"))

#MNAR IV (NULL)
BMY0_IV <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMY_IV(0).xlsx', 1)
BMCY0_IV <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/BMCY_IV(0).xlsx', 1)
CMY0_IV <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMY_IV(0).xlsx', 1)
CMBY0_IV <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/CMBY_IV(0).xlsx', 1)
...
BMY0_IV_NIE_MLE<-cbind(BMY0_IV[c(21),4,],'NIE','MLE','A.IV (0)')
...
BMY0_IV_NDE_MLE<-cbind(BMY0_IV[c(22),4,],'NDE','MLE','A.IV (0)')
...
BMCY0_IV_NIE_MLE<-cbind(BMCY0_IV[c(22),4,],'NIE','MLE','B.IV (0)')
...
BMCY0_IV_NDE_MLE<-cbind(BMCY0_IV[c(23),4,],'NDE','MLE','B.IV (0)')
...
CMY0_IV_NIE_MLE<-cbind(CMY0_IV[c(23),4,],'NIE','MLE','C.IV (0)')
...
CMY0_IV_NDE_MLE<-cbind(CMY0_IV[c(24),4,],'NDE','MLE','C.IV (0)')
...
CMBY0_IV_NIE_MLE<-cbind(CMBY0_IV[c(22),4,],'NIE','MLE','D.IV (0)')
...
CMBY0_IV_NDE_MLE<-cbind(CMBY0_IV[c(23),4,],'NDE','MLE','D.IV (0)')

MNAR0_IV<-as.data.frame(rbind(BMY0_IV_NIE_OR,BMY0_IV_NIE_CC,BMY0_IV_NIE_MI,BMY0_IV_NIE_MLE,
                              BMY0_IV_NDE_OR,BMY0_IV_NDE_CC,BMY0_IV_NDE_MI,BMY0_IV_NDE_MLE,
                              BMCY0_IV_NIE_OR,BMCY0_IV_NIE_CC,BMCY0_IV_NIE_MI,BMCY0_IV_NIE_MLE,
                              BMCY0_IV_NDE_OR,BMCY0_IV_NDE_CC,BMCY0_IV_NDE_MI,BMCY0_IV_NDE_MLE,
                              CMY0_IV_NIE_OR,CMY0_IV_NIE_CC,CMY0_IV_NIE_MI,CMY0_IV_NIE_MLE,
                              CMY0_IV_NDE_OR,CMY0_IV_NDE_CC,CMY0_IV_NDE_MI,CMY0_IV_NDE_MLE,
                              CMBY0_IV_NIE_OR,CMBY0_IV_NIE_CC,CMBY0_IV_NIE_MI,CMBY0_IV_NIE_MLE,
                              CMBY0_IV_NDE_OR,CMBY0_IV_NDE_CC,CMBY0_IV_NDE_MI,CMBY0_IV_NDE_MLE))
...
MNAR0_IV$method <- factor(MNAR0_IV$method, levels=c("CC","MI","MLE","OR"))
...
DMBY_I <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/DMBY_I.xlsx', 1)
DMBY_I <- array(as.numeric(unlist(DMBY_I)), dim = c(28, 4, 500))
DMBY_I_OR <- as.data.frame(t(DMBY_I[1:28,1,]))
DMBY_I_MLE <- as.data.frame(t(DMBY_I[1:28,4,]))
#oracle
...
#mle
mlepar1<-cbind(DMBY_I_MLE[1],"mlea_02")
colnames(mlepar1)<-c("value","par")
mlepar2<-cbind(DMBY_I_MLE[2],"mlea_t2")
colnames(mlepar2)<-c("value","par")
mlepar3<-cbind(DMBY_I_MLE[3],"mlea_x2")
colnames(mlepar3)<-c("value","par")
mlepar4<-cbind(DMBY_I_MLE[4],"mlea_03")
colnames(mlepar4)<-c("value","par")
mlepar5<-cbind(DMBY_I_MLE[5],"mlea_t3")
colnames(mlepar5)<-c("value","par")
mlepar6<-cbind(DMBY_I_MLE[6],"mlea_x3")
colnames(mlepar6)<-c("value","par")
mlepar7<-cbind(DMBY_I_MLE[7],"mleb_0")
colnames(mlepar7)<-c("value","par")
mlepar8<-cbind(DMBY_I_MLE[8],"mleb_m2")
colnames(mlepar8)<-c("value","par")
mlepar9<-cbind(DMBY_I_MLE[9],"mleb_m3")
colnames(mlepar9)<-c("value","par")
mlepar10<-cbind(DMBY_I_MLE[10],"mleb_t")
colnames(mlepar10)<-c("value","par")
mlepar11<-cbind(DMBY_I_MLE[11],"mleb_x")
colnames(mlepar11)<-c("value","par")
mlepar12<-cbind(DMBY_I_MLE[12],"mleb_mt2")
colnames(mlepar12)<-c("value","par")
mlepar13<-cbind(DMBY_I_MLE[13],"mleb_mt3")
colnames(mlepar13)<-c("value","par")
mlepar14<-cbind(DMBY_I_MLE[14],"mlec_0")
colnames(mlepar14)<-c("value","par")
mlepar15<-cbind(DMBY_I_MLE[15],"mlec_m2")
colnames(mlepar15)<-c("value","par")
mlepar16<-cbind(DMBY_I_MLE[16],"mlec_m3")
colnames(mlepar16)<-c("value","par")
mlepar17<-cbind(DMBY_I_MLE[17],"mlec_t")
colnames(mlepar17)<-c("value","par")
mlepar18<-cbind(DMBY_I_MLE[18],"mlec_x")
colnames(mlepar18)<-c("value","par")
mlepar19<-cbind(DMBY_I_MLE[19],"mleNIE")
colnames(mlepar19)<-c("value","par")
mlepar20<-cbind(DMBY_I_MLE[20],"mleNDE")
colnames(mlepar20)<-c("value","par")
mlepar<-rbind(mlepar1,mlepar2,mlepar3,mlepar4,mlepar5,mlepar6,mlepar7,mlepar8,mlepar9,mlepar10,mlepar11,mlepar12,mlepar13,mlepar14,mlepar15,mlepar16,mlepar17,mlepar18,mlepar19,mlepar20)
mlepar$par<-factor(mlepar$par, 
                  levels=c("mlea_02","mlea_t2","mlea_x2","mlea_03","mlea_t3","mlea_x3","mleb_0","mleb_m2","mleb_m3","mleb_t","mleb_x","mleb_mt2","mleb_mt3","mlec_0","mlec_m2","mlec_m3","mlec_t","mlec_x","mleNIE","mleNDE"), 
                  labels=c(expression(MLE:alpha["10"]), expression(MLE:alpha["1t"]), expression(MLE:alpha["1x"]),
                           expression(MLE:alpha["20"]), expression(MLE:alpha["2t"]), expression(MLE:alpha["2x"]),
                           expression(MLE:beta["0"]), expression(MLE:beta["m1"]), expression(MLE:beta["m2"]), expression(MLE:beta["t"]), expression(MLE:beta["x"]), expression(MLE:beta["mt1"]), expression(MLE:beta["mt2"]),
                           expression(MLE:lambda["0"]), expression(MLE:lambda["m1"]), expression(MLE:lambda["m2"]), expression(MLE:lambda["t"]), expression(MLE:lambda["x"]),
                           expression(MLE:NIE), expression(MLE:NDE)))
#combinded
par <- rbind(orpar,mlepar)
...
ref <- data.frame(par = c("ta_02","ta_t2","ta_x2","ta_03","ta_t3","ta_x3","tb_0","tb_m2","tb_m3","tb_t","tb_x","tb_mt2","tb_mt3","tc_0","tc_m2","tc_m3","tc_t","tc_x","tNIE","tNDE",
                          "mlea_02","mlea_t2","mlea_x2","mlea_03","mlea_t3","mlea_x3","mleb_0","mleb_m2","mleb_m3","mleb_t","mleb_x","mleb_mt2","mleb_mt3","mlec_0","mlec_m2","mlec_m3","mlec_t","mlec_x","mleNIE","mleNDE"), 
...
ref$par <- factor(ref$par, 
                  ...
                  labels=c(expression(OR:alpha["10"]), expression(OR:alpha["1t"]), expression(OR:alpha["1x"]),
                           ...
                           expression(OR:lambda["0"]), expression(OR:lambda["m1"]), expression(OR:lambda["m2"]), expression(OR:lambda["t"]), expression(OR:lambda["x"]),
                           expression(OR:NIE), expression(OR:NDE), 
                           expression(MLE:alpha["10"]), expression(MLE:alpha["1t"]), expression(MLE:alpha["1x"]),
                           expression(MLE:alpha["20"]), expression(MLE:alpha["2t"]), expression(MLE:alpha["2x"]),
                           expression(MLE:beta["0"]), expression(MLE:beta["m1"]), expression(MLE:beta["m2"]), expression(MLE:beta["t"]), expression(MLE:beta["x"]), expression(MLE:beta["mt1"]), expression(MLE:beta["mt2"]),
                           expression(MLE:lambda["0"]), expression(MLE:lambda["m1"]), expression(MLE:lambda["m2"]), expression(MLE:lambda["t"]), expression(MLE:lambda["x"]),
                           expression(MLE:NIE), expression(MLE:NDE)))
...
DMBY_IV <- read.xlsx('/Users/sushi5824907/Desktop/reproducibility_materials/Simulation2/output/DMBY_IV.xlsx', 1)
DMBY_IV <- array(as.numeric(unlist(DMBY_IV)), dim = c(35, 4, 500))
DMBY_IV_OR <- as.data.frame(t(DMBY_IV[1:35,1,]))
DMBY_IV_MLE <- as.data.frame(t(DMBY_IV[1:35,4,]))
#oracle
...
orpar$par<-factor(orpar$par, 
                  ...
                  labels=c(expression(OR:alpha["10"]), expression(OR:alpha["1t"]), expression(OR:alpha["1x"]),
                           ...
                           expression(OR:NIE), expression(OR:NDE)))
#mle
mlepar1<-cbind(DMBY_IV_MLE[1],"mlea_02")
colnames(mlepar1)<-c("value","par")
mlepar2<-cbind(DMBY_IV_MLE[2],"mlea_t2")
colnames(mlepar2)<-c("value","par")
mlepar3<-cbind(DMBY_IV_MLE[3],"mlea_x2")
colnames(mlepar3)<-c("value","par")
mlepar4<-cbind(DMBY_IV_MLE[4],"mlea_03")
colnames(mlepar4)<-c("value","par")
mlepar5<-cbind(DMBY_IV_MLE[5],"mlea_t3")
colnames(mlepar5)<-c("value","par")
mlepar6<-cbind(DMBY_IV_MLE[6],"mlea_x3")
colnames(mlepar6)<-c("value","par")
mlepar7<-cbind(DMBY_IV_MLE[7],"mleb_0")
colnames(mlepar7)<-c("value","par")
mlepar8<-cbind(DMBY_IV_MLE[8],"mleb_m2")
colnames(mlepar8)<-c("value","par")
mlepar9<-cbind(DMBY_IV_MLE[9],"mleb_m3")
colnames(mlepar9)<-c("value","par")
mlepar10<-cbind(DMBY_IV_MLE[10],"mleb_t")
colnames(mlepar10)<-c("value","par")
mlepar11<-cbind(DMBY_IV_MLE[11],"mleb_x")
colnames(mlepar11)<-c("value","par")
mlepar12<-cbind(DMBY_IV_MLE[12],"mleb_mt2")
colnames(mlepar12)<-c("value","par")
mlepar13<-cbind(DMBY_IV_MLE[13],"mleb_mt3")
colnames(mlepar13)<-c("value","par")
mlepar14<-cbind(DMBY_IV_MLE[14],"mlec_0")
colnames(mlepar14)<-c("value","par")
mlepar15<-cbind(DMBY_IV_MLE[15],"mlec_m2")
colnames(mlepar15)<-c("value","par")
mlepar16<-cbind(DMBY_IV_MLE[16],"mlec_m3")
colnames(mlepar16)<-c("value","par")
mlepar17<-cbind(DMBY_IV_MLE[17],"mlec_t")
colnames(mlepar17)<-c("value","par")
mlepar18<-cbind(DMBY_IV_MLE[18],"mlec_x")
colnames(mlepar18)<-c("value","par")
mlepar19<-cbind(DMBY_IV_MLE[19],"mled_0")
colnames(mlepar19)<-c("value","par")
mlepar20<-cbind(DMBY_IV_MLE[20],"mled_m2")
colnames(mlepar20)<-c("value","par")
mlepar21<-cbind(DMBY_IV_MLE[21],"mled_m3")
colnames(mlepar21)<-c("value","par")
mlepar22<-cbind(DMBY_IV_MLE[22],"mled_t")
colnames(mlepar22)<-c("value","par")
mlepar23<-cbind(DMBY_IV_MLE[23],"mled_x")
colnames(mlepar23)<-c("value","par")
mlepar24<-cbind(DMBY_IV_MLE[24],"mleNIE")
colnames(mlepar24)<-c("value","par")
mlepar25<-cbind(DMBY_IV_MLE[25],"mleNDE")
colnames(mlepar25)<-c("value","par")
mlepar<-rbind(mlepar1,mlepar2,mlepar3,mlepar4,mlepar5,mlepar6,mlepar7,mlepar8,mlepar9,mlepar10,mlepar11,mlepar12,mlepar13,mlepar14,mlepar15,mlepar16,mlepar17,mlepar18,mlepar19,mlepar20,mlepar21,mlepar22,mlepar23,mlepar24,mlepar25)
mlepar$par<-factor(mlepar$par, 
                  levels=c("mlea_02","mlea_t2","mlea_x2","mlea_03","mlea_t3","mlea_x3","mleb_0","mleb_m2","mleb_m3","mleb_t","mleb_x","mleb_mt2","mleb_mt3","mlec_0","mlec_m2","mlec_m3","mlec_t","mlec_x","mled_0","mled_m2","mled_m3","mled_t","mled_x","mleNIE","mleNDE"), 
                  labels=c(expression(MLE:alpha["10"]), expression(MLE:alpha["1t"]), expression(MLE:alpha["1x"]),
                           expression(MLE:alpha["20"]), expression(MLE:alpha["2t"]), expression(MLE:alpha["2x"]),
                           expression(MLE:beta["0"]), expression(MLE:beta["m1"]), expression(MLE:beta["m2"]), expression(MLE:beta["t"]), expression(MLE:beta["x"]), expression(MLE:beta["mt1"]), expression(MLE:beta["mt2"]),
                           expression(MLE:lambda["0"]), expression(MLE:lambda["m1"]), expression(MLE:lambda["m2"]), expression(MLE:lambda["t"]), expression(MLE:lambda["x"]),
                           expression(MLE:gamma["0"]), expression(MLE:gamma["m1"]), expression(MLE:gamma["m2"]), expression(MLE:gamma["t"]), expression(MLE:gamma["x"]),
                           expression(MLE:NIE), expression(MLE:NDE)))
#combinded
par <- rbind(orpar,mlepar)
#true value of the parameter
ref <- data.frame(par = c("ta_02","ta_t2","ta_x2","ta_03","ta_t3","ta_x3","tb_0","tb_m2","tb_m3","tb_t","tb_x","tb_mt2","tb_mt3","tc_0","tc_m2","tc_m3","tc_t","tc_x","td_0","td_m2","td_m3","td_t","td_x","tNIE","tNDE",
                          "mlea_02","mlea_t2","mlea_x2","mlea_03","mlea_t3","mlea_x3","mleb_0","mleb_m2","mleb_m3","mleb_t","mleb_x","mleb_mt2","mleb_mt3","mlec_0","mlec_m2","mlec_m3","mlec_t","mlec_x","mled_0","mled_m2","mled_m3","mled_t","mled_x","mleNIE","mleNDE"), 
...
CMBY_I_MLE <- as.data.frame(t(CMBY_I[1:23,4,]))
#oracle
...
orpar$par<-factor(orpar$par, 
                  ...
                  labels = c(expression(OR:alpha["0"]), expression(OR:alpha["t"]), expression(OR:alpha["x"]), expression(OR:sigma["m"]),
                             ...
                             expression(OR:NIE), expression(OR:NDE)))
#mle
mlepar1<-cbind(CMBY_I_MLE[1],"mlea_0")
colnames(mlepar1)<-c("value","par")
mlepar2<-cbind(CMBY_I_MLE[2],"mlea_t")
colnames(mlepar2)<-c("value","par")
mlepar3<-cbind(CMBY_I_MLE[3],"mlea_x")
colnames(mlepar3)<-c("value","par")
mlepar4<-cbind(CMBY_I_MLE[4],"mlesd_m")
colnames(mlepar4)<-c("value","par")
mlepar5<-cbind(CMBY_I_MLE[5],"mleb_0")
colnames(mlepar5)<-c("value","par")
mlepar6<-cbind(CMBY_I_MLE[6],"mleb_m")
colnames(mlepar6)<-c("value","par")
mlepar7<-cbind(CMBY_I_MLE[7],"mleb_t")
colnames(mlepar7)<-c("value","par")
mlepar8<-cbind(CMBY_I_MLE[8],"mleb_x")
colnames(mlepar8)<-c("value","par")
mlepar9<-cbind(CMBY_I_MLE[9],"mleb_mt")
colnames(mlepar9)<-c("value","par")
mlepar10<-cbind(CMBY_I_MLE[10],"mlec_0")
colnames(mlepar10)<-c("value","par")
mlepar11<-cbind(CMBY_I_MLE[11],"mlec_m")
colnames(mlepar11)<-c("value","par")
mlepar12<-cbind(CMBY_I_MLE[12],"mlec_t")
colnames(mlepar12)<-c("value","par")
mlepar13<-cbind(CMBY_I_MLE[13],"mlec_x")
colnames(mlepar13)<-c("value","par")
mlepar14<-cbind(CMBY_I_MLE[14],"mleNIE")
colnames(mlepar14)<-c("value","par")
mlepar15<-cbind(CMBY_I_MLE[15],"mleNDE")
colnames(mlepar15)<-c("value","par")
mlepar<-rbind(mlepar1,mlepar2,mlepar3,mlepar4,mlepar5,mlepar6,mlepar7,mlepar8,mlepar9,mlepar10,mlepar11,mlepar12,mlepar13,mlepar14,mlepar15)
mlepar$par<-factor(mlepar$par, 
                  levels = c("mlea_0","mlea_t","mlea_x","mlesd_m","mleb_0","mleb_m","mleb_t","mleb_x","mleb_mt","mlec_0","mlec_m","mlec_t","mlec_x","mleNIE","mleNDE"), 
                  labels = c(expression(MLE:alpha["0"]), expression(MLE:alpha["t"]), expression(MLE:alpha["x"]), expression(MLE:sigma["m"]),
                             expression(MLE:beta["0"]), expression(MLE:beta["m"]), expression(MLE:beta["t"]), expression(MLE:beta["x"]), expression(MLE:beta["mt"]), 
                             expression(MLE:lambda["0"]), expression(MLE:lambda["m"]), expression(MLE:lambda["t"]), expression(MLE:lambda["x"]),
                             expression(MLE:NIE), expression(MLE:NDE)))
#combinded
par <- rbind(orpar,mlepar)
#true value of the parameter
ref <- data.frame(par = c("ta_0","ta_t","ta_x","tsd_m","tb_0","tb_m","tb_t","tb_x","tb_mt","tc_0","tc_m","tc_t","tc_x","tNIE","tNDE",
                          "mlea_0","mlea_t","mlea_x","mlesd_m","mleb_0","mleb_m","mleb_t","mleb_x","mleb_mt","mlec_0","mlec_m","mlec_t","mlec_x","mleNIE","mleNDE"), 
...
ref$par <- factor(ref$par, 
                  ...
                  labels = c(expression(OR:alpha["0"]), expression(OR:alpha["t"]), expression(OR:alpha["x"]),
                             ...
                             expression(OR:lambda["0"]), expression(OR:lambda["m"]), expression(OR:lambda["t"]), expression(OR:lambda["x"]),
                             expression(OR:NIE), expression(OR:NDE), 
                             expression(MLE:alpha["0"]), expression(MLE:alpha["t"]), expression(MLE:alpha["x"]),
                             expression(MLE:sigma["m"]),
                             expression(MLE:beta["0"]), expression(MLE:beta["m"]), expression(MLE:beta["t"]), expression(MLE:beta["x"]), expression(MLE:beta["mt"]), 
                             expression(MLE:lambda["0"]), expression(MLE:lambda["m"]), expression(MLE:lambda["t"]), expression(MLE:lambda["x"]),
                             expression(MLE:NIE), expression(MLE:NDE)))
ref$type <- "True value of the parameter"
