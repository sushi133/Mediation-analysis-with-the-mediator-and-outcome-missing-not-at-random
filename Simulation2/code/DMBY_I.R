...
#arguments: x: covariate, b_0-a_x3: parameters in M and Y models
#output: E[Y(1,M(1))]
...
write.xlsx(save,'/Users/sushi5824907/Desktop/Mediation/JASA/Simulation2/DMBY_I.xlsx',row.names = FALSE)
