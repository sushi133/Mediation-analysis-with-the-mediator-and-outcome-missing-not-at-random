...
#purpose: calculate weight of y using estimated parameters and observed data
#arguments: m,t,x: observed data, y: possible value for y
#output: weight of y 
...
#purpose: calculate weight of (y,m) using estimated parameters and observed data
#arguments: t,x: observed data, y: possible value for y, m: possible value for m
#output: weight of (y,m) 
...
write.xlsx(save,'/Users/sushi5824907/Desktop/Mediation/JASA/Simulation2/BMY_III(0).xlsx',row.names = FALSE)
