...
BMY_I<-array(as.numeric(unlist(BMY_I)), dim = c(17, 3, 1000))
BMCY_I<-array(as.numeric(unlist(BMCY_I)), dim = c(17, 3, 1000))
CMY_I<-array(as.numeric(unlist(CMY_I)), dim = c(17, 3, 1000))
CMBY_I<-array(as.numeric(unlist(CMBY_I)), dim = c(17, 3, 1000))
...
BMCY_I_NIE_OR<-cbind(BMCY_I[c(13),1,],'NIE','Oracle','B.I')
BMCY_I_NIE_CC<-cbind(BMCY_I[c(13),2,],'NIE','CC','B.I')
BMCY_I_NIE_EM<-cbind(BMCY_I[c(13),3,],'NIE','EM','B.I')
BMCY_I_NDE_OR<-cbind(BMCY_I[c(14),1,],'NDE','Oracle','B.I')
BMCY_I_NDE_CC<-cbind(BMCY_I[c(14),2,],'NDE','CC','B.I')
BMCY_I_NDE_EM<-cbind(BMCY_I[c(14),3,],'NDE','EM','B.I')

CMY_I_NIE_OR<-cbind(CMY_I[c(13),1,],'NIE','Oracle','C.I')
CMY_I_NIE_CC<-cbind(CMY_I[c(13),2,],'NIE','CC','C.I')
CMY_I_NIE_EM<-cbind(CMY_I[c(13),3,],'NIE','EM','C.I')
CMY_I_NDE_OR<-cbind(CMY_I[c(14),1,],'NDE','Oracle','C.I')
CMY_I_NDE_CC<-cbind(CMY_I[c(14),2,],'NDE','CC','C.I')
CMY_I_NDE_EM<-cbind(CMY_I[c(14),3,],'NDE','EM','C.I')

CMBY_I_NIE_OR<-cbind(CMBY_I[c(13),1,],'NIE','Oracle','D.I')
CMBY_I_NIE_CC<-cbind(CMBY_I[c(13),2,],'NIE','CC','D.I')
CMBY_I_NIE_EM<-cbind(CMBY_I[c(13),3,],'NIE','EM','D.I')
CMBY_I_NDE_OR<-cbind(CMBY_I[c(14),1,],'NDE','Oracle','D.I')
CMBY_I_NDE_CC<-cbind(CMBY_I[c(14),2,],'NDE','CC','D.I')
CMBY_I_NDE_EM<-cbind(CMBY_I[c(14),3,],'NDE','EM','D.I')
...
BMY_II<-array(as.numeric(unlist(BMY_II)), dim = c(23, 3, 1000))
BMCY_II<-array(as.numeric(unlist(BMCY_II)), dim = c(23, 3, 1000))
CMY_II<-array(as.numeric(unlist(CMY_II)), dim = c(23, 3, 1000))
CMBY_II<-array(as.numeric(unlist(CMBY_II)), dim = c(23, 3, 1000))
...
BMCY_II_NIE_OR<-cbind(BMCY_II[c(17),1,],'NIE','Oracle','B.II')
BMCY_II_NIE_CC<-cbind(BMCY_II[c(17),2,],'NIE','CC','B.II')
BMCY_II_NIE_EM<-cbind(BMCY_II[c(17),3,],'NIE','EM','B.II')
BMCY_II_NDE_OR<-cbind(BMCY_II[c(18),1,],'NDE','Oracle','B.II')
BMCY_II_NDE_CC<-cbind(BMCY_II[c(18),2,],'NDE','CC','B.II')
BMCY_II_NDE_EM<-cbind(BMCY_II[c(18),3,],'NDE','EM','B.II')

CMY_II_NIE_OR<-cbind(CMY_II[c(17),1,],'NIE','Oracle','C.II')
CMY_II_NIE_CC<-cbind(CMY_II[c(17),2,],'NIE','CC','C.II')
CMY_II_NIE_EM<-cbind(CMY_II[c(17),3,],'NIE','EM','C.II')
CMY_II_NDE_OR<-cbind(CMY_II[c(18),1,],'NDE','Oracle','C.II')
CMY_II_NDE_CC<-cbind(CMY_II[c(18),2,],'NDE','CC','C.II')
CMY_II_NDE_EM<-cbind(CMY_II[c(18),3,],'NDE','EM','C.II')

CMBY_II_NIE_OR<-cbind(CMBY_II[c(17),1,],'NIE','Oracle','D.II')
CMBY_II_NIE_CC<-cbind(CMBY_II[c(17),2,],'NIE','CC','D.II')
CMBY_II_NIE_EM<-cbind(CMBY_II[c(17),3,],'NIE','EM','D.II')
CMBY_II_NDE_OR<-cbind(CMBY_II[c(18),1,],'NDE','Oracle','D.II')
CMBY_II_NDE_CC<-cbind(CMBY_II[c(18),2,],'NDE','CC','D.II')
CMBY_II_NDE_EM<-cbind(CMBY_II[c(18),3,],'NDE','EM','D.II')
...
BMY_III<-array(as.numeric(unlist(BMY_III)), dim = c(23, 3, 1000))
BMCY_III<-array(as.numeric(unlist(BMCY_III)), dim = c(23, 3, 1000))
CMY_III<-array(as.numeric(unlist(CMY_III)), dim = c(23, 3, 1000))
CMBY_III<-array(as.numeric(unlist(CMBY_III)), dim = c(23, 3, 1000))
...
BMCY_III_NIE_OR<-cbind(BMCY_III[c(17),1,],'NIE','Oracle','B.III')
BMCY_III_NIE_CC<-cbind(BMCY_III[c(17),2,],'NIE','CC','B.III')
BMCY_III_NIE_EM<-cbind(BMCY_III[c(17),3,],'NIE','EM','B.III')
BMCY_III_NDE_OR<-cbind(BMCY_III[c(18),1,],'NDE','Oracle','B.III')
BMCY_III_NDE_CC<-cbind(BMCY_III[c(18),2,],'NDE','CC','B.III')
BMCY_III_NDE_EM<-cbind(BMCY_III[c(18),3,],'NDE','EM','B.III')

CMY_III_NIE_OR<-cbind(CMY_III[c(17),1,],'NIE','Oracle','C.III')
CMY_III_NIE_CC<-cbind(CMY_III[c(17),2,],'NIE','CC','C.III')
CMY_III_NIE_EM<-cbind(CMY_III[c(17),3,],'NIE','EM','C.III')
CMY_III_NDE_OR<-cbind(CMY_III[c(18),1,],'NDE','Oracle','C.III')
CMY_III_NDE_CC<-cbind(CMY_III[c(18),2,],'NDE','CC','C.III')
CMY_III_NDE_EM<-cbind(CMY_III[c(18),3,],'NDE','EM','C.III')

CMBY_III_NIE_OR<-cbind(CMBY_III[c(17),1,],'NIE','Oracle','D.III')
CMBY_III_NIE_CC<-cbind(CMBY_III[c(17),2,],'NIE','CC','D.III')
CMBY_III_NIE_EM<-cbind(CMBY_III[c(17),3,],'NIE','EM','D.III')
CMBY_III_NDE_OR<-cbind(CMBY_III[c(18),1,],'NDE','Oracle','D.III')
CMBY_III_NDE_CC<-cbind(CMBY_III[c(18),2,],'NDE','CC','D.III')
CMBY_III_NDE_EM<-cbind(CMBY_III[c(18),3,],'NDE','EM','D.III')
...
BMY_IV<-array(as.numeric(unlist(BMY_IV)), dim = c(23, 3, 1000))
BMCY_IV<-array(as.numeric(unlist(BMCY_IV)), dim = c(23, 3, 1000))
CMY_IV<-array(as.numeric(unlist(CMY_IV)), dim = c(23, 3, 1000))
CMBY_IV<-array(as.numeric(unlist(CMBY_IV)), dim = c(23, 3, 1000))
...
BMCY_IV_NIE_OR<-cbind(BMCY_IV[c(17),1,],'NIE','Oracle','B.IV')
BMCY_IV_NIE_CC<-cbind(BMCY_IV[c(17),2,],'NIE','CC','B.IV')
BMCY_IV_NIE_EM<-cbind(BMCY_IV[c(17),3,],'NIE','EM','B.IV')
BMCY_IV_NDE_OR<-cbind(BMCY_IV[c(18),1,],'NDE','Oracle','B.IV')
BMCY_IV_NDE_CC<-cbind(BMCY_IV[c(18),2,],'NDE','CC','B.IV')
BMCY_IV_NDE_EM<-cbind(BMCY_IV[c(18),3,],'NDE','EM','B.IV')

CMY_IV_NIE_OR<-cbind(CMY_IV[c(17),1,],'NIE','Oracle','C.IV')
CMY_IV_NIE_CC<-cbind(CMY_IV[c(17),2,],'NIE','CC','C.IV')
CMY_IV_NIE_EM<-cbind(CMY_IV[c(17),3,],'NIE','EM','C.IV')
CMY_IV_NDE_OR<-cbind(CMY_IV[c(18),1,],'NDE','Oracle','C.IV')
CMY_IV_NDE_CC<-cbind(CMY_IV[c(18),2,],'NDE','CC','C.IV')
CMY_IV_NDE_EM<-cbind(CMY_IV[c(18),3,],'NDE','EM','C.IV')

CMBY_IV_NIE_OR<-cbind(CMBY_IV[c(17),1,],'NIE','Oracle','D.IV')
CMBY_IV_NIE_CC<-cbind(CMBY_IV[c(17),2,],'NIE','CC','D.IV')
CMBY_IV_NIE_EM<-cbind(CMBY_IV[c(17),3,],'NIE','EM','D.IV')
CMBY_IV_NDE_OR<-cbind(CMBY_IV[c(18),1,],'NDE','Oracle','D.IV')
CMBY_IV_NDE_CC<-cbind(CMBY_IV[c(18),2,],'NDE','CC','D.IV')
CMBY_IV_NDE_EM<-cbind(CMBY_IV[c(18),3,],'NDE','EM','D.IV')
...
BMY0_I<-array(as.numeric(unlist(BMY0_I)), dim = c(17, 3, 1000))
BMCY0_I<-array(as.numeric(unlist(BMCY0_I)), dim = c(17, 3, 1000))
CMY0_I<-array(as.numeric(unlist(CMY0_I)), dim = c(17, 3, 1000))
CMBY0_I<-array(as.numeric(unlist(CMBY0_I)), dim = c(17, 3, 1000))
...
BMCY0_I_NIE_OR<-cbind(BMCY0_I[c(13),1,],'NIE','Oracle','B.I (0)')
BMCY0_I_NIE_CC<-cbind(BMCY0_I[c(13),2,],'NIE','CC','B.I (0)')
BMCY0_I_NIE_EM<-cbind(BMCY0_I[c(13),3,],'NIE','EM','B.I (0)')
BMCY0_I_NDE_OR<-cbind(BMCY0_I[c(14),1,],'NDE','Oracle','B.I (0)')
BMCY0_I_NDE_CC<-cbind(BMCY0_I[c(14),2,],'NDE','CC','B.I (0)')
BMCY0_I_NDE_EM<-cbind(BMCY0_I[c(14),3,],'NDE','EM','B.I (0)')

CMY0_I_NIE_OR<-cbind(CMY0_I[c(13),1,],'NIE','Oracle','C.I (0)')
CMY0_I_NIE_CC<-cbind(CMY0_I[c(13),2,],'NIE','CC','C.I (0)')
CMY0_I_NIE_EM<-cbind(CMY0_I[c(13),3,],'NIE','EM','C.I (0)')
CMY0_I_NDE_OR<-cbind(CMY0_I[c(14),1,],'NDE','Oracle','C.I (0)')
CMY0_I_NDE_CC<-cbind(CMY0_I[c(14),2,],'NDE','CC','C.I (0)')
CMY0_I_NDE_EM<-cbind(CMY0_I[c(14),3,],'NDE','EM','C.I (0)')

CMBY0_I_NIE_OR<-cbind(CMBY0_I[c(13),1,],'NIE','Oracle','D.I (0)')
CMBY0_I_NIE_CC<-cbind(CMBY0_I[c(13),2,],'NIE','CC','D.I (0)')
CMBY0_I_NIE_EM<-cbind(CMBY0_I[c(13),3,],'NIE','EM','D.I (0)')
CMBY0_I_NDE_OR<-cbind(CMBY0_I[c(14),1,],'NDE','Oracle','D.I (0)')
CMBY0_I_NDE_CC<-cbind(CMBY0_I[c(14),2,],'NDE','CC','D.I (0)')
CMBY0_I_NDE_EM<-cbind(CMBY0_I[c(14),3,],'NDE','EM','D.I (0)')
...
BMY0_II<-array(as.numeric(unlist(BMY0_II)), dim = c(23, 3, 1000))
BMCY0_II<-array(as.numeric(unlist(BMCY0_II)), dim = c(23, 3, 1000))
CMY0_II<-array(as.numeric(unlist(CMY0_II)), dim = c(23, 3, 1000))
CMBY0_II<-array(as.numeric(unlist(CMBY0_II)), dim = c(23, 3, 1000))
...
BMCY0_II_NIE_OR<-cbind(BMCY0_II[c(17),1,],'NIE','Oracle','B.II (0)')
BMCY0_II_NIE_CC<-cbind(BMCY0_II[c(17),2,],'NIE','CC','B.II (0)')
BMCY0_II_NIE_EM<-cbind(BMCY0_II[c(17),3,],'NIE','EM','B.II (0)')
BMCY0_II_NDE_OR<-cbind(BMCY0_II[c(18),1,],'NDE','Oracle','B.II (0)')
BMCY0_II_NDE_CC<-cbind(BMCY0_II[c(18),2,],'NDE','CC','B.II (0)')
BMCY0_II_NDE_EM<-cbind(BMCY0_II[c(18),3,],'NDE','EM','B.II (0)')

CMY0_II_NIE_OR<-cbind(CMY0_II[c(17),1,],'NIE','Oracle','C.II (0)')
CMY0_II_NIE_CC<-cbind(CMY0_II[c(17),2,],'NIE','CC','C.II (0)')
CMY0_II_NIE_EM<-cbind(CMY0_II[c(17),3,],'NIE','EM','C.II (0)')
CMY0_II_NDE_OR<-cbind(CMY0_II[c(18),1,],'NDE','Oracle','C.II (0)')
CMY0_II_NDE_CC<-cbind(CMY0_II[c(18),2,],'NDE','CC','C.II (0)')
CMY0_II_NDE_EM<-cbind(CMY0_II[c(18),3,],'NDE','EM','C.II (0)')

CMBY0_II_NIE_OR<-cbind(CMBY0_II[c(17),1,],'NIE','Oracle','D.II (0)')
CMBY0_II_NIE_CC<-cbind(CMBY0_II[c(17),2,],'NIE','CC','D.II (0)')
CMBY0_II_NIE_EM<-cbind(CMBY0_II[c(17),3,],'NIE','EM','D.II (0)')
CMBY0_II_NDE_OR<-cbind(CMBY0_II[c(18),1,],'NDE','Oracle','D.II (0)')
CMBY0_II_NDE_CC<-cbind(CMBY0_II[c(18),2,],'NDE','CC','D.II (0)')
CMBY0_II_NDE_EM<-cbind(CMBY0_II[c(18),3,],'NDE','EM','D.II (0)')
...
BMY0_III<-array(as.numeric(unlist(BMY0_III)), dim = c(23, 3, 1000))
BMCY0_III<-array(as.numeric(unlist(BMCY0_III)), dim = c(23, 3, 1000))
CMY0_III<-array(as.numeric(unlist(CMY0_III)), dim = c(23, 3, 1000))
CMBY0_III<-array(as.numeric(unlist(CMBY0_III)), dim = c(23, 3, 1000))
...
BMCY0_III_NIE_OR<-cbind(BMCY0_III[c(17),1,],'NIE','Oracle','B.III (0)')
BMCY0_III_NIE_CC<-cbind(BMCY0_III[c(17),2,],'NIE','CC','B.III (0)')
BMCY0_III_NIE_EM<-cbind(BMCY0_III[c(17),3,],'NIE','EM','B.III (0)')
BMCY0_III_NDE_OR<-cbind(BMCY0_III[c(18),1,],'NDE','Oracle','B.III (0)')
BMCY0_III_NDE_CC<-cbind(BMCY0_III[c(18),2,],'NDE','CC','B.III (0)')
BMCY0_III_NDE_EM<-cbind(BMCY0_III[c(18),3,],'NDE','EM','B.III (0)')

CMY0_III_NIE_OR<-cbind(CMY0_III[c(17),1,],'NIE','Oracle','C.III (0)')
CMY0_III_NIE_CC<-cbind(CMY0_III[c(17),2,],'NIE','CC','C.III (0)')
CMY0_III_NIE_EM<-cbind(CMY0_III[c(17),3,],'NIE','EM','C.III (0)')
CMY0_III_NDE_OR<-cbind(CMY0_III[c(18),1,],'NDE','Oracle','C.III (0)')
CMY0_III_NDE_CC<-cbind(CMY0_III[c(18),2,],'NDE','CC','C.III (0)')
CMY0_III_NDE_EM<-cbind(CMY0_III[c(18),3,],'NDE','EM','C.III (0)')

CMBY0_III_NIE_OR<-cbind(CMBY0_III[c(17),1,],'NIE','Oracle','D.III (0)')
CMBY0_III_NIE_CC<-cbind(CMBY0_III[c(17),2,],'NIE','CC','D.III (0)')
CMBY0_III_NIE_EM<-cbind(CMBY0_III[c(17),3,],'NIE','EM','D.III (0)')
CMBY0_III_NDE_OR<-cbind(CMBY0_III[c(18),1,],'NDE','Oracle','D.III (0)')
CMBY0_III_NDE_CC<-cbind(CMBY0_III[c(18),2,],'NDE','CC','D.III (0)')
CMBY0_III_NDE_EM<-cbind(CMBY0_III[c(18),3,],'NDE','EM','D.III (0)')
...
BMY0_IV<-array(as.numeric(unlist(BMY0_IV)), dim = c(23, 3, 1000))
BMCY0_IV<-array(as.numeric(unlist(BMCY0_IV)), dim = c(23, 3, 1000))
CMY0_IV<-array(as.numeric(unlist(CMY0_IV)), dim = c(23, 3, 1000))
CMBY0_IV<-array(as.numeric(unlist(CMBY0_IV)), dim = c(23, 3, 1000))
...
BMCY0_IV_NIE_OR<-cbind(BMCY0_IV[c(17),1,],'NIE','Oracle','B.IV (0)')
BMCY0_IV_NIE_CC<-cbind(BMCY0_IV[c(17),2,],'NIE','CC','B.IV (0)')
BMCY0_IV_NIE_EM<-cbind(BMCY0_IV[c(17),3,],'NIE','EM','B.IV (0)')
BMCY0_IV_NDE_OR<-cbind(BMCY0_IV[c(18),1,],'NDE','Oracle','B.IV (0)')
BMCY0_IV_NDE_CC<-cbind(BMCY0_IV[c(18),2,],'NDE','CC','B.IV (0)')
BMCY0_IV_NDE_EM<-cbind(BMCY0_IV[c(18),3,],'NDE','EM','B.IV (0)')

CMY0_IV_NIE_OR<-cbind(CMY0_IV[c(17),1,],'NIE','Oracle','C.IV (0)')
CMY0_IV_NIE_CC<-cbind(CMY0_IV[c(17),2,],'NIE','CC','C.IV (0)')
CMY0_IV_NIE_EM<-cbind(CMY0_IV[c(17),3,],'NIE','EM','C.IV (0)')
CMY0_IV_NDE_OR<-cbind(CMY0_IV[c(18),1,],'NDE','Oracle','C.IV (0)')
CMY0_IV_NDE_CC<-cbind(CMY0_IV[c(18),2,],'NDE','CC','C.IV (0)')
CMY0_IV_NDE_EM<-cbind(CMY0_IV[c(18),3,],'NDE','EM','C.IV (0)')

CMBY0_IV_NIE_OR<-cbind(CMBY0_IV[c(17),1,],'NIE','Oracle','D.IV (0)')
CMBY0_IV_NIE_CC<-cbind(CMBY0_IV[c(17),2,],'NIE','CC','D.IV (0)')
CMBY0_IV_NIE_EM<-cbind(CMBY0_IV[c(17),3,],'NIE','EM','D.IV (0)')
CMBY0_IV_NDE_OR<-cbind(CMBY0_IV[c(18),1,],'NDE','Oracle','D.IV (0)')
CMBY0_IV_NDE_CC<-cbind(CMBY0_IV[c(18),2,],'NDE','CC','D.IV (0)')
CMBY0_IV_NDE_EM<-cbind(CMBY0_IV[c(18),3,],'NDE','EM','D.IV (0)')
