...
#EM
#possible value for discrete var and fractional imputation for continuous var
...
#weight of y when m is observed
...
while (sum(abs(Q[[k]]-Q[[k-1]]))/sum(Q[[k-1]])>=1e-5) {
  ...
  dat3<-dat3 %>% group_by(seq,y) %>% mutate(wt=wt/sum(wt))
  dat3$wt<-dat3$wt*y_weight(dat3$y,dat3$m,dat3$t,dat3$x)
...
miTIE<-mean(as.numeric(unlist(lapply(1:N,FUN=int11,data=data,b_0=mib_0,b_m=mib_m,b_t=mib_t,b_mt=mib_mt,b_x=mib_x,a_0=mia_0,a_t=mia_t,a_x=mia_x,sd_m=misd_m))))-
       mean(as.numeric(unlist(lapply(1:N,FUN=int10,data=data,b_0=mib_0,b_m=mib_m,b_t=mib_t,b_mt=mib_mt,b_x=mib_x,a_0=mia_0,a_t=mia_t,a_x=mia_x,sd_m=misd_m))))
miPDE<-mean(as.numeric(unlist(lapply(1:N,FUN=int10,data=data,b_0=mib_0,b_m=mib_m,b_t=mib_t,b_mt=mib_mt,b_x=mib_x,a_0=mia_0,a_t=mia_t,a_x=mia_x,sd_m=misd_m))))-
       mean(as.numeric(unlist(lapply(1:N,FUN=int00,data=data,b_0=mib_0,b_m=mib_m,b_t=mib_t,b_mt=mib_mt,b_x=mib_x,a_0=mia_0,a_t=mia_t,a_x=mia_x,sd_m=misd_m))))
miPIE<-mean(as.numeric(unlist(lapply(1:N,FUN=int01,data=data,b_0=mib_0,b_m=mib_m,b_t=mib_t,b_mt=mib_mt,b_x=mib_x,a_0=mia_0,a_t=mia_t,a_x=mia_x,sd_m=misd_m))))-
       mean(as.numeric(unlist(lapply(1:N,FUN=int00,data=data,b_0=mib_0,b_m=mib_m,b_t=mib_t,b_mt=mib_mt,b_x=mib_x,a_0=mia_0,a_t=mia_t,a_x=mia_x,sd_m=misd_m))))
miTDE<-mean(as.numeric(unlist(lapply(1:N,FUN=int11,data=data,b_0=mib_0,b_m=mib_m,b_t=mib_t,b_mt=mib_mt,b_x=mib_x,a_0=mia_0,a_t=mia_t,a_x=mia_x,sd_m=misd_m))))-
       mean(as.numeric(unlist(lapply(1:N,FUN=int01,data=data,b_0=mib_0,b_m=mib_m,b_t=mib_t,b_mt=mib_mt,b_x=mib_x,a_0=mia_0,a_t=mia_t,a_x=mia_x,sd_m=misd_m))))
...
write.xlsx(save,'/Users/sushi5824907/Desktop/Mediation/JASA/Simulation/CMBY_III(0).xlsx',row.names = FALSE)
