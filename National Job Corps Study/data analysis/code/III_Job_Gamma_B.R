...
write.xlsx(timediff,'/Users/sushi5824907/Desktop/Mediation/JASA/Data_Analysis/Compute_time(hours).xlsx',
           row.names = FALSE,sheetName="III_Job_Gamma_B",append=TRUE)

#save param
write.xlsx(save,'/Users/sushi5824907/Desktop/Mediation/JASA/Data_Analysis/III_Job_Gamma_B_Param.xlsx',row.names = FALSE)
param <- read.xlsx('/Users/sushi5824907/Desktop/Mediation/JASA/Data_Analysis/III_Job_Gamma_B_Param.xlsx', 1)
...
library("xlsx")
write.xlsx(tab,'/Users/sushi5824907/Desktop/Mediation/JASA/Data_Analysis/III_Job_Gamma_B.xlsx',row.names = FALSE)
