...
cond_prob_1<-
    ...
    (exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*1+sens_y*I_Y+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))/(1+exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*1+sens_y*I_Y+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
...
cond_prob_0<-
    ...
    (exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*0+sens_y*I_Y+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))/(1+exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*0+sens_y*I_Y+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
...
cond_prob<-
    ...
    (exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*M+sens_y*I_Y+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))/(1+exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*M+sens_y*I_Y+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
  
  return(cond_prob/(cond_prob_1+cond_prob_0))
}

#purpose: calculate weight of I_Y using estimated parameters and observed data
#arguments: M,Z,x1,x2,x3,x4,x5,x6,x7,R_m: observed data, I_Y: possible value for I_Y
#output: weight of I_Y
y_weight<-function(I_Y,M,Z,x1,x2,x3,x4,x5,x6,x7,R_m){
...
cond_prob<-
    ...
    (1+exp(emb0_0+emb0_m*M+emb0_t*Z+emb0_mt*M*Z+emb0_x1*I(x1==1)+emb0_x21*I(x2==1)+emb0_x22*I(x2==2)+emb0_x31*I(x3==1)+emb0_x32*I(x3==2)+emb0_x33*I(x3==3)+emb0_x4*I(x4==1)+emb0_x51*I(x5==1)+emb0_x52*I(x5==2)+emb0_x62*I(x6==2)+emb0_x63*I(x6==3)+emb0_x64*I(x6==4)+emb0_x71*I(x7==1)+emb0_x72*I(x7==2)+emb0_x73*I(x7==3)+emb0_x74*I(x7==4)+emb0_x75*I(x7==5))))^I(I_Y==1)*
    (1/(1+exp(emb0_0+emb0_m*M+emb0_t*Z+emb0_mt*M*Z+emb0_x1*I(x1==1)+emb0_x21*I(x2==1)+emb0_x22*I(x2==2)+emb0_x31*I(x3==1)+emb0_x32*I(x3==2)+emb0_x33*I(x3==3)+emb0_x4*I(x4==1)+emb0_x51*I(x5==1)+emb0_x52*I(x5==2)+emb0_x62*I(x6==2)+emb0_x63*I(x6==3)+emb0_x64*I(x6==4)+emb0_x71*I(x7==1)+emb0_x72*I(x7==2)+emb0_x73*I(x7==3)+emb0_x74*I(x7==4)+emb0_x75*I(x7==5))))^I(I_Y==0)*
    (1/(1+exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*M+sens_y*I_Y+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
  
  return(cond_prob/(cond_prob_1+cond_prob_0))
}

#purpose: calculate weight of (I_Y,M) using estimated parameters and observed data
#arguments: Z,x1,x2,x3,x4,x5,x6,x7,R_m: observed data, I_Y: possible value for I_Y, M: possible value for M
#output: weight of (I_Y,M)
my_weight<-function(I_Y,M,Z,x1,x2,x3,x4,x5,x6,x7,R_m){
...
while (sum(abs(Q[[k]]-Q[[k-1]]))/sum(Q[[k-1]])>=1e-5) {
  ...
  #missing Y
  dat2<-subset(dat, R_m==1 & R_y==0)
  dat2$wt<-y_weight(dat2$I_Y,dat2$M,dat2$Z,dat2$x1,dat2$x2,dat2$x3,dat2$x4,dat2$x5,dat2$x6,dat2$x7,dat2$R_m)
  
  #missing M and Y
  dat3<-subset(dat, R_m==0 & R_y==0)
  dat3$wt<-my_weight(dat3$I_Y,dat3$M,dat3$Z,dat3$x1,dat3$x2,dat3$x3,dat3$x4,dat3$x5,dat3$x6,dat3$x7,dat3$R_m)
  ...
  emm4<-glm(R_y~R_m+Z+x1+x2+x3+x4+x5+x6+x7+offset(sens_m*M)+offset(sens_y*I_Y),family = binomial(link='logit'),weights=wt,data=dat)
...
write.xlsx(timediff,'/Users/sushi5824907/Desktop/Mediation/JASA/Sensitivity_Analysis/Compute_time(hours).xlsx',
           row.names = FALSE,sheetName="II_Job_Gamma_S_B_-2_2",append=TRUE)
