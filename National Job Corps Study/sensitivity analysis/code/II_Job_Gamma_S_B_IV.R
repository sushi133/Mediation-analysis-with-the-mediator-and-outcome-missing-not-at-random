...
write.xlsx(timediff,'/Users/sushi5824907/Desktop/Mediation/JASA/Sensitivity_Analysis/Compute_time(hours).xlsx',
           row.names = FALSE,sheetName="II_Job_Gamma_S_B_0_0",append=TRUE)

#save param
write.xlsx(save,'/Users/sushi5824907/Desktop/Mediation/JASA/Sensitivity_Analysis/II_Job_Gamma_S_B_0_0_Param.xlsx',row.names = FALSE)
param <- read.xlsx('/Users/sushi5824907/Desktop/Mediation/JASA/Sensitivity_Analysis/II_Job_Gamma_S_B_0_0_Param.xlsx', 1)
...
library("xlsx")
write.xlsx(tab,'/Users/sushi5824907/Desktop/Mediation/JASA/Sensitivity_Analysis/II_Job_Gamma_S_B_0_0.xlsx',row.names = FALSE)
