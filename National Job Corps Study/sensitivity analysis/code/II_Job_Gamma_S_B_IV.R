...
ccm1<-glm(Y~M+Z+M*Z+x1+x2+x3+x4+x5+x6+x7,family=Gamma(link = "log"),data=dat,subset=(R_m==1 & R_y==1 & I_Y==1))
...
#arguments: Y,I_Y,Z,x1,x2,x3,x4,x5,x6,x7,R_m: observed data, M: possible value for M
#output: weight of M 
m_weight<-function(Y,I_Y,M,Z,x1,x2,x3,x4,x5,x6,x7,R_m){
...
cond_prob_1<-
    ...
    (exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*1+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))/(1+exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*1+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
...
cond_prob_0<-
    ...
    (exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*0+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))/(1+exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*0+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
...
cond_prob<-
    ...
    (exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*M+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))/(1+exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*M+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
  
  return(cond_prob/(cond_prob_1+cond_prob_0))
}

#purpose: calculate weight of M using estimated parameters and observed data
#arguments: Z,x1,x2,x3,x4,x5,x6,x7,R_m: observed data, M: possible value for M
#output: weight of M 
...
cond_prob_1<-
    (exp(ema_0+ema_t*Z+ema_x1*I(x1==1)+ema_x21*I(x2==1)+ema_x22*I(x2==2)+ema_x31*I(x3==1)+ema_x32*I(x3==2)+ema_x33*I(x3==3)+ema_x4*I(x4==1)+ema_x51*I(x5==1)+ema_x52*I(x5==2)+ema_x62*I(x6==2)+ema_x63*I(x6==3)+ema_x64*I(x6==4)+ema_x71*I(x7==1)+ema_x72*I(x7==2)+ema_x73*I(x7==3)+ema_x74*I(x7==4)+ema_x75*I(x7==5))/(1+exp(ema_0+ema_t*Z+ema_x1*I(x1==1)+ema_x21*I(x2==1)+ema_x22*I(x2==2)+ema_x31*I(x3==1)+ema_x32*I(x3==2)+ema_x33*I(x3==3)+ema_x4*I(x4==1)+ema_x51*I(x5==1)+ema_x52*I(x5==2)+ema_x62*I(x6==2)+ema_x63*I(x6==3)+ema_x64*I(x6==4)+ema_x71*I(x7==1)+ema_x72*I(x7==2)+ema_x73*I(x7==3)+ema_x74*I(x7==4)+ema_x75*I(x7==5))))*
    (1/(1+exp(emc_0+emc_m*1+emc_t*Z+emc_x1*I(x1==1)+emc_x21*I(x2==1)+emc_x22*I(x2==2)+emc_x31*I(x3==1)+emc_x32*I(x3==2)+emc_x33*I(x3==3)+emc_x4*I(x4==1)+emc_x51*I(x5==1)+emc_x52*I(x5==2)+emc_x62*I(x6==2)+emc_x63*I(x6==3)+emc_x64*I(x6==4)+emc_x71*I(x7==1)+emc_x72*I(x7==2)+emc_x73*I(x7==3)+emc_x74*I(x7==4)+emc_x75*I(x7==5))))*
    (1/(1+exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*1+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
  
cond_prob_0<-
    (1/(1+exp(ema_0+ema_t*Z+ema_x1*I(x1==1)+ema_x21*I(x2==1)+ema_x22*I(x2==2)+ema_x31*I(x3==1)+ema_x32*I(x3==2)+ema_x33*I(x3==3)+ema_x4*I(x4==1)+ema_x51*I(x5==1)+ema_x52*I(x5==2)+ema_x62*I(x6==2)+ema_x63*I(x6==3)+ema_x64*I(x6==4)+ema_x71*I(x7==1)+ema_x72*I(x7==2)+ema_x73*I(x7==3)+ema_x74*I(x7==4)+ema_x75*I(x7==5))))*
    (1/(1+exp(emc_0+emc_m*0+emc_t*Z+emc_x1*I(x1==1)+emc_x21*I(x2==1)+emc_x22*I(x2==2)+emc_x31*I(x3==1)+emc_x32*I(x3==2)+emc_x33*I(x3==3)+emc_x4*I(x4==1)+emc_x51*I(x5==1)+emc_x52*I(x5==2)+emc_x62*I(x6==2)+emc_x63*I(x6==3)+emc_x64*I(x6==4)+emc_x71*I(x7==1)+emc_x72*I(x7==2)+emc_x73*I(x7==3)+emc_x74*I(x7==4)+emc_x75*I(x7==5))))*
    (1/(1+exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*0+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
  
cond_prob<-
    (exp(ema_0+ema_t*Z+ema_x1*I(x1==1)+ema_x21*I(x2==1)+ema_x22*I(x2==2)+ema_x31*I(x3==1)+ema_x32*I(x3==2)+ema_x33*I(x3==3)+ema_x4*I(x4==1)+ema_x51*I(x5==1)+ema_x52*I(x5==2)+ema_x62*I(x6==2)+ema_x63*I(x6==3)+ema_x64*I(x6==4)+ema_x71*I(x7==1)+ema_x72*I(x7==2)+ema_x73*I(x7==3)+ema_x74*I(x7==4)+ema_x75*I(x7==5))/(1+exp(ema_0+ema_t*Z+ema_x1*I(x1==1)+ema_x21*I(x2==1)+ema_x22*I(x2==2)+ema_x31*I(x3==1)+ema_x32*I(x3==2)+ema_x33*I(x3==3)+ema_x4*I(x4==1)+ema_x51*I(x5==1)+ema_x52*I(x5==2)+ema_x62*I(x6==2)+ema_x63*I(x6==3)+ema_x64*I(x6==4)+ema_x71*I(x7==1)+ema_x72*I(x7==2)+ema_x73*I(x7==3)+ema_x74*I(x7==4)+ema_x75*I(x7==5))))^I(M==1)*
    (1/(1+exp(ema_0+ema_t*Z+ema_x1*I(x1==1)+ema_x21*I(x2==1)+ema_x22*I(x2==2)+ema_x31*I(x3==1)+ema_x32*I(x3==2)+ema_x33*I(x3==3)+ema_x4*I(x4==1)+ema_x51*I(x5==1)+ema_x52*I(x5==2)+ema_x62*I(x6==2)+ema_x63*I(x6==3)+ema_x64*I(x6==4)+ema_x71*I(x7==1)+ema_x72*I(x7==2)+ema_x73*I(x7==3)+ema_x74*I(x7==4)+ema_x75*I(x7==5))))^I(M==0)*
    (1/(1+exp(emc_0+emc_m*M+emc_t*Z+emc_x1*I(x1==1)+emc_x21*I(x2==1)+emc_x22*I(x2==2)+emc_x31*I(x3==1)+emc_x32*I(x3==2)+emc_x33*I(x3==3)+emc_x4*I(x4==1)+emc_x51*I(x5==1)+emc_x52*I(x5==2)+emc_x62*I(x6==2)+emc_x63*I(x6==3)+emc_x64*I(x6==4)+emc_x71*I(x7==1)+emc_x72*I(x7==2)+emc_x73*I(x7==3)+emc_x74*I(x7==4)+emc_x75*I(x7==5))))*
    (1/(1+exp(emd_0+emd_rm*R_m+emd_t*Z+sens_m*M+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
...
while (sum(abs(Q[[k]]-Q[[k-1]]))/sum(Q[[k-1]])>=1e-5) {
  ...
  #missing M
  dat1<-subset(dat, R_m==0 & R_y==1)
  dat1$wt<-m_weight(dat1$Y,dat1$I_Y,dat1$M,dat1$Z,dat1$x1,dat1$x2,dat1$x3,dat1$x4,dat1$x5,dat1$x6,dat1$x7,dat1$R_m)
  ...
  #missing M and Y
  dat3<-subset(dat, R_m==0 & R_y==0)
  dat3$wt<-my_weight(dat3$M,dat3$Z,dat3$x1,dat3$x2,dat3$x3,dat3$x4,dat3$x5,dat3$x6,dat3$x7,dat3$R_m)
  ...
  emm4<-glm(R_y~R_m+Z+x1+x2+x3+x4+x5+x6+x7+offset(sens_m*M),family = binomial(link='logit'),weights=wt,data=dat)
...
write.xlsx(timediff,'/Users/sushi5824907/Desktop/Mediation/JASA/Sensitivity_Analysis/Compute_time(hours).xlsx',
           row.names = FALSE,sheetName="II_Job_Gamma_S_B_0_2",append=TRUE)

#save param
write.xlsx(save,'/Users/sushi5824907/Desktop/Mediation/JASA/Sensitivity_Analysis/II_Job_Gamma_S_B_0_2_Param.xlsx',row.names = FALSE)
param <- read.xlsx('/Users/sushi5824907/Desktop/Mediation/JASA/Sensitivity_Analysis/II_Job_Gamma_S_B_0_2_Param.xlsx', 1)
...
library("xlsx")
write.xlsx(tab,'/Users/sushi5824907/Desktop/Mediation/JASA/Sensitivity_Analysis/II_Job_Gamma_S_B_0_2.xlsx',row.names = FALSE)
