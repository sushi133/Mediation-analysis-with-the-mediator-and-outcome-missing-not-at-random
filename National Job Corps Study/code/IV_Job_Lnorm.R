...
mim4<-summary(pool(with(imp, glm(R_y~M+Z+x1+x2+x3+x4+x5+x6+x7,family=binomial(link='logit')))))
...
cond_prob_1<-
  ...
  (exp(emd_0+emd_m*1+emd_t*Z+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))/(1+exp(emd_0+emd_m*1+emd_t*Z+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
...
cond_prob_0<-
  ...
  (exp(emd_0+emd_m*0+emd_t*Z+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))/(1+exp(emd_0+emd_m*0+emd_t*Z+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
...
cond_prob<-
  ...
  (exp(emd_0+emd_m*M+emd_t*Z+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))/(1+exp(emd_0+emd_m*M+emd_t*Z+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
...
cond_prob_1<-
    (exp(ema_0+ema_t*Z+ema_x1*I(x1==1)+ema_x21*I(x2==1)+ema_x22*I(x2==2)+ema_x31*I(x3==1)+ema_x32*I(x3==2)+ema_x33*I(x3==3)+ema_x4*I(x4==1)+ema_x51*I(x5==1)+ema_x52*I(x5==2)+ema_x62*I(x6==2)+ema_x63*I(x6==3)+ema_x64*I(x6==4)+ema_x71*I(x7==1)+ema_x72*I(x7==2)+ema_x73*I(x7==3)+ema_x74*I(x7==4)+ema_x75*I(x7==5))/(1+exp(ema_0+ema_t*Z+ema_x1*I(x1==1)+ema_x21*I(x2==1)+ema_x22*I(x2==2)+ema_x31*I(x3==1)+ema_x32*I(x3==2)+ema_x33*I(x3==3)+ema_x4*I(x4==1)+ema_x51*I(x5==1)+ema_x52*I(x5==2)+ema_x62*I(x6==2)+ema_x63*I(x6==3)+ema_x64*I(x6==4)+ema_x71*I(x7==1)+ema_x72*I(x7==2)+ema_x73*I(x7==3)+ema_x74*I(x7==4)+ema_x75*I(x7==5))))*
    (1/(1+exp(emc_0+emc_m*1+emc_t*Z+emc_x1*I(x1==1)+emc_x21*I(x2==1)+emc_x22*I(x2==2)+emc_x31*I(x3==1)+emc_x32*I(x3==2)+emc_x33*I(x3==3)+emc_x4*I(x4==1)+emc_x51*I(x5==1)+emc_x52*I(x5==2)+emc_x62*I(x6==2)+emc_x63*I(x6==3)+emc_x64*I(x6==4)+emc_x71*I(x7==1)+emc_x72*I(x7==2)+emc_x73*I(x7==3)+emc_x74*I(x7==4)+emc_x75*I(x7==5))))*
    (1/(1+exp(emd_0+emd_m*1+emd_t*Z+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
  
cond_prob_0<-
    (1/(1+exp(ema_0+ema_t*Z+ema_x1*I(x1==1)+ema_x21*I(x2==1)+ema_x22*I(x2==2)+ema_x31*I(x3==1)+ema_x32*I(x3==2)+ema_x33*I(x3==3)+ema_x4*I(x4==1)+ema_x51*I(x5==1)+ema_x52*I(x5==2)+ema_x62*I(x6==2)+ema_x63*I(x6==3)+ema_x64*I(x6==4)+ema_x71*I(x7==1)+ema_x72*I(x7==2)+ema_x73*I(x7==3)+ema_x74*I(x7==4)+ema_x75*I(x7==5))))*
    (1/(1+exp(emc_0+emc_m*0+emc_t*Z+emc_x1*I(x1==1)+emc_x21*I(x2==1)+emc_x22*I(x2==2)+emc_x31*I(x3==1)+emc_x32*I(x3==2)+emc_x33*I(x3==3)+emc_x4*I(x4==1)+emc_x51*I(x5==1)+emc_x52*I(x5==2)+emc_x62*I(x6==2)+emc_x63*I(x6==3)+emc_x64*I(x6==4)+emc_x71*I(x7==1)+emc_x72*I(x7==2)+emc_x73*I(x7==3)+emc_x74*I(x7==4)+emc_x75*I(x7==5))))*
    (1/(1+exp(emd_0+emd_m*0+emd_t*Z+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))

cond_prob<-
    (exp(ema_0+ema_t*Z+ema_x1*I(x1==1)+ema_x21*I(x2==1)+ema_x22*I(x2==2)+ema_x31*I(x3==1)+ema_x32*I(x3==2)+ema_x33*I(x3==3)+ema_x4*I(x4==1)+ema_x51*I(x5==1)+ema_x52*I(x5==2)+ema_x62*I(x6==2)+ema_x63*I(x6==3)+ema_x64*I(x6==4)+ema_x71*I(x7==1)+ema_x72*I(x7==2)+ema_x73*I(x7==3)+ema_x74*I(x7==4)+ema_x75*I(x7==5))/(1+exp(ema_0+ema_t*Z+ema_x1*I(x1==1)+ema_x21*I(x2==1)+ema_x22*I(x2==2)+ema_x31*I(x3==1)+ema_x32*I(x3==2)+ema_x33*I(x3==3)+ema_x4*I(x4==1)+ema_x51*I(x5==1)+ema_x52*I(x5==2)+ema_x62*I(x6==2)+ema_x63*I(x6==3)+ema_x64*I(x6==4)+ema_x71*I(x7==1)+ema_x72*I(x7==2)+ema_x73*I(x7==3)+ema_x74*I(x7==4)+ema_x75*I(x7==5))))^I(M==1)*
    (1/(1+exp(ema_0+ema_t*Z+ema_x1*I(x1==1)+ema_x21*I(x2==1)+ema_x22*I(x2==2)+ema_x31*I(x3==1)+ema_x32*I(x3==2)+ema_x33*I(x3==3)+ema_x4*I(x4==1)+ema_x51*I(x5==1)+ema_x52*I(x5==2)+ema_x62*I(x6==2)+ema_x63*I(x6==3)+ema_x64*I(x6==4)+ema_x71*I(x7==1)+ema_x72*I(x7==2)+ema_x73*I(x7==3)+ema_x74*I(x7==4)+ema_x75*I(x7==5))))^I(M==0)*
    (1/(1+exp(emc_0+emc_m*M+emc_t*Z+emc_x1*I(x1==1)+emc_x21*I(x2==1)+emc_x22*I(x2==2)+emc_x31*I(x3==1)+emc_x32*I(x3==2)+emc_x33*I(x3==3)+emc_x4*I(x4==1)+emc_x51*I(x5==1)+emc_x52*I(x5==2)+emc_x62*I(x6==2)+emc_x63*I(x6==3)+emc_x64*I(x6==4)+emc_x71*I(x7==1)+emc_x72*I(x7==2)+emc_x73*I(x7==3)+emc_x74*I(x7==4)+emc_x75*I(x7==5))))*
    (1/(1+exp(emd_0+emd_m*M+emd_t*Z+emd_x1*I(x1==1)+emd_x21*I(x2==1)+emd_x22*I(x2==2)+emd_x31*I(x3==1)+emd_x32*I(x3==2)+emd_x33*I(x3==3)+emd_x4*I(x4==1)+emd_x51*I(x5==1)+emd_x52*I(x5==2)+emd_x62*I(x6==2)+emd_x63*I(x6==3)+emd_x64*I(x6==4)+emd_x71*I(x7==1)+emd_x72*I(x7==2)+emd_x73*I(x7==3)+emd_x74*I(x7==4)+emd_x75*I(x7==5))))
...
Q[[2]] <-c(ema_0,ema_t,ema_x1,ema_x21,ema_x22,ema_x31,ema_x32,ema_x33,ema_x4,ema_x51,ema_x52,ema_x62,ema_x63,ema_x64,ema_x71,ema_x72,ema_x73,ema_x74,ema_x75,
           ...
           emd_0,emd_m,emd_t,emd_x1,emd_x21,emd_x22,emd_x31,emd_x32,emd_x33,emd_x4,emd_x51,emd_x52,emd_x62,emd_x63,emd_x64,emd_x71,emd_x72,emd_x73,emd_x74,emd_x75)
k<-2
while (sum(abs(Q[[k]]-Q[[k-1]]))/sum(Q[[k-1]])>=1e-5) {
 ...
 emm4<-glm(R_y~M+Z+x1+x2+x3+x4+x5+x6+x7,family = binomial(link='logit'),weights=wt,data=dat)
...
l10<-((1/(dat10$Y*emsd_y*sqrt(2*pi)))*exp((-0.5*((log(dat10$Y)-(emb_0+emb_m*dat10$M+emb_t*dat10$Z+emb_mt*dat10$M*dat10$Z+emb_x1*I(dat10$x1==1)+emb_x21*I(dat10$x2==1)+emb_x22*I(dat10$x2==2)+emb_x31*I(dat10$x3==1)+emb_x32*I(dat10$x3==2)+emb_x33*I(dat10$x3==3)+emb_x4*I(dat10$x4==1)+emb_x51*I(dat10$x5==1)+emb_x52*I(dat10$x5==2)+emb_x62*I(dat10$x6==2)+emb_x63*I(dat10$x6==3)+emb_x64*I(dat10$x6==4)+emb_x71*I(dat10$x7==1)+emb_x72*I(dat10$x7==2)+emb_x73*I(dat10$x7==3)+emb_x74*I(dat10$x7==4)+emb_x75*I(dat10$x7==5)))/emsd_y)^2))*
     ...
     (exp(emd_0+emd_m*dat10$M+emd_t*dat10$Z+emd_x1*I(dat10$x1==1)+emd_x21*I(dat10$x2==1)+emd_x22*I(dat10$x2==2)+emd_x31*I(dat10$x3==1)+emd_x32*I(dat10$x3==2)+emd_x33*I(dat10$x3==3)+emd_x4*I(dat10$x4==1)+emd_x51*I(dat10$x5==1)+emd_x52*I(dat10$x5==2)+emd_x62*I(dat10$x6==2)+emd_x63*I(dat10$x6==3)+emd_x64*I(dat10$x6==4)+emd_x71*I(dat10$x7==1)+emd_x72*I(dat10$x7==2)+emd_x73*I(dat10$x7==3)+emd_x74*I(dat10$x7==4)+emd_x75*I(dat10$x7==5))/(1+exp(emd_0+emd_m*dat10$M+emd_t*dat10$Z+emd_x1*I(dat10$x1==1)+emd_x21*I(dat10$x2==1)+emd_x22*I(dat10$x2==2)+emd_x31*I(dat10$x3==1)+emd_x32*I(dat10$x3==2)+emd_x33*I(dat10$x3==3)+emd_x4*I(dat10$x4==1)+emd_x51*I(dat10$x5==1)+emd_x52*I(dat10$x5==2)+emd_x62*I(dat10$x6==2)+emd_x63*I(dat10$x6==3)+emd_x64*I(dat10$x6==4)+emd_x71*I(dat10$x7==1)+emd_x72*I(dat10$x7==2)+emd_x73*I(dat10$x7==3)+emd_x74*I(dat10$x7==4)+emd_x75*I(dat10$x7==5))))
#missing m (m=1)
l11<-((1/(dat11$Y*emsd_y*sqrt(2*pi)))*exp((-0.5*((log(dat11$Y)-(emb_0+emb_m*dat11$M+emb_t*dat11$Z+emb_mt*dat11$M*dat11$Z+emb_x1*I(dat11$x1==1)+emb_x21*I(dat11$x2==1)+emb_x22*I(dat11$x2==2)+emb_x31*I(dat11$x3==1)+emb_x32*I(dat11$x3==2)+emb_x33*I(dat11$x3==3)+emb_x4*I(dat11$x4==1)+emb_x51*I(dat11$x5==1)+emb_x52*I(dat11$x5==2)+emb_x62*I(dat11$x6==2)+emb_x63*I(dat11$x6==3)+emb_x64*I(dat11$x6==4)+emb_x71*I(dat11$x7==1)+emb_x72*I(dat11$x7==2)+emb_x73*I(dat11$x7==3)+emb_x74*I(dat11$x7==4)+emb_x75*I(dat11$x7==5)))/emsd_y)^2))*
     ...
     (exp(emd_0+emd_m*dat11$M+emd_t*dat11$Z+emd_x1*I(dat11$x1==1)+emd_x21*I(dat11$x2==1)+emd_x22*I(dat11$x2==2)+emd_x31*I(dat11$x3==1)+emd_x32*I(dat11$x3==2)+emd_x33*I(dat11$x3==3)+emd_x4*I(dat11$x4==1)+emd_x51*I(dat11$x5==1)+emd_x52*I(dat11$x5==2)+emd_x62*I(dat11$x6==2)+emd_x63*I(dat11$x6==3)+emd_x64*I(dat11$x6==4)+emd_x71*I(dat11$x7==1)+emd_x72*I(dat11$x7==2)+emd_x73*I(dat11$x7==3)+emd_x74*I(dat11$x7==4)+emd_x75*I(dat11$x7==5))/(1+exp(emd_0+emd_m*dat11$M+emd_t*dat11$Z+emd_x1*I(dat11$x1==1)+emd_x21*I(dat11$x2==1)+emd_x22*I(dat11$x2==2)+emd_x31*I(dat11$x3==1)+emd_x32*I(dat11$x3==2)+emd_x33*I(dat11$x3==3)+emd_x4*I(dat11$x4==1)+emd_x51*I(dat11$x5==1)+emd_x52*I(dat11$x5==2)+emd_x62*I(dat11$x6==2)+emd_x63*I(dat11$x6==3)+emd_x64*I(dat11$x6==4)+emd_x71*I(dat11$x7==1)+emd_x72*I(dat11$x7==2)+emd_x73*I(dat11$x7==3)+emd_x74*I(dat11$x7==4)+emd_x75*I(dat11$x7==5))))
#missing y
...
library("xlsx")
write.xlsx(tab,'/Users/sushi5824907/Desktop/Mediation/JASA/Data_Analysis/IV_Job_Lnorm.xlsx',row.names = FALSE)
