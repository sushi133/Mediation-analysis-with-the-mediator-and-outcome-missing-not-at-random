...
while (sum(abs(Q[[k]]-Q[[k-1]]))/sum(Q[[k-1]])>=1e-5) {
  ...
  #update parameters
  emm1<-lm(y~m+t+m*t+x,weights=wt,data=dat,subset=(R_m==1))
...
write.xlsx(save,'/Users/sushi5824907/Desktop/Mediation/JASA/Simulation_v2/CMY_I(0).xlsx',row.names = FALSE)
